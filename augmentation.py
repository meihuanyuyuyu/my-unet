...
from utils import save_result_json
...
class Color_jitter(ColorJitter):
...
label = Image.open('TCGA-18-5592-01Z-00-DX1.png')
img = Image.open('img.png')
cj = Color_jitter(0,0,[1.5,2.0])
img,label = cj(img,label)
img,label = TF.to_tensor(img),TF.to_tensor(label)
save_image(img,'cj_img.png')
